...
class _SudokuInputScreenState extends State<SudokuInputScreen> {
  ...
  void submitGrid() {
    ...
    solveSudoku(solved); // call solver from utils
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => SudokuResultScreen(solvedGrid: solved)),
    );
  }
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                margin: EdgeInsets.only(
                  left: j % 3 == 0 ? 4 : 1, // extra space every 3 cols
                  right: 1,
                  top: i % 3 == 0 ? 4 : 1, // extra space every 3 rows
                  bottom: 1,
                ),
